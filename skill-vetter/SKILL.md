---
name: skill-vetter
description: Security vetting protocol before installing any AI agent skill from external source. Red flag detection for credential theft, obfuscated code, exfiltration. Risk classification LOW/MEDIUM/HIGH/EXTREME. Produces structured vetting reports. Must use and only use this when safety concerns arise with external agent skills.
---

# Skill Vetter 🔒

Security-first vetting protocol for AI agent skills. **Never install a skill from external source without vetting it first.**
